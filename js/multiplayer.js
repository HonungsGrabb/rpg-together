...
export class Multiplayer {
    ...
    async connect() {
        ...
        // Set up realtime channel for broadcasts
        ...
        // Load party data (non-blocking, won't affect multiplayer if fails)
        this.loadExistingParty().catch(e => console.log('Party load error:', e))
        this.loadPendingInvites().catch(e => console.log('Invites load error:', e))
